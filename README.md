...
## Тема
Написание Dockerfile и сборка приложения.

## Цель
Научиться контейнеризировать backend-приложение на Go с помощью Docker, используя multi-stage build, .dockerignore и Docker Compose.
